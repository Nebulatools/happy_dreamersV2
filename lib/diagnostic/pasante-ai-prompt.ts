...
const SURVEY_FIELD_LABELS: Record<string, string> = {
  ...
  temperaturaCuarto: "Temperatura del cuarto (siempre en Celsius)",
  roomTemperature: "Temperatura del cuarto (C)",
  unidadTemperatura: "Unidad de temperatura (C/F)",
  temperaturaOriginal: "Temperatura ingresada por el padre (valor original)",
