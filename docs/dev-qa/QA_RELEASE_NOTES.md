...
Vas a recorrer toda la app como si fueras Mariana (admin) atendiendo pacientes.
Cada **CHECKPOINT** tiene casillas de verificacion. Marca OK o FALLA.

**Tiempo estimado:** 25-35 minutos

**Prerequisito:** La app debe estar corriendo y debe haber **al menos 1 paciente con survey completado y algunos eventos registrados**. Si la base de datos esta vacia, usa la cuenta de padre para crear un nino y llenar su encuesta desde la UI.
...
## PARTE 1: Login, Sidebar y Navegacion

### CHECKPOINT 1: Sidebar Simplificado

1. Login como `mariana@admin.com` / `password`
2. Observa el sidebar izquierdo

**Verificar:**
- [ ] El sidebar tiene: Dashboard, Pacientes, Consultas, Diagnosticos, Asistente, Calendario, Reportes
- [ ] **NO** aparecen: Ayuda, Contacto
- [ ] Configuracion esta pegada al **fondo** del sidebar (abajo de todo, separada del resto)
- [ ] El header superior muestra un icono de busqueda (lupa)

---

## PARTE 2: Busqueda Global

### CHECKPOINT 2: Busqueda Child-Centric

1. Click en el icono de busqueda (lupa) en el header
2. Escribe el nombre de un nino que exista en el sistema

**Verificar:**
- [ ] Aparecen resultados con nombre del nino
- [ ] Al hacer click en un resultado, navega a la vista de ese nino (Patient Hub)
- [ ] Si buscas algo que no existe, no hay crash (se muestra vacio o "sin resultados")
...
- [ ] "Total de Pacientes" muestra un numero real (no 0 ni placeholder)
- [ ] Al hacer click/hover en "Total de Pacientes", muestra desglose: activos, inactivos, archivados
- [ ] "Alertas Clinicas" muestra contadores (rojo para criticas, amarillo para advertencias)
