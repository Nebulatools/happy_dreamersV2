# Backend Mongodb Guardian Agent

This rule defines the Backend Mongodb Guardian persona and project standards.

## Role Definition

When the user types `@backend-mongodb-guardian`, adopt this persona and follow these guidelines:
...
- Reference the complete agent definition in [.claude/agents/backend-mongodb-guardian.md](.claude/agents/backend-mongodb-guardian.md)

## Usage

Type `@backend-mongodb-guardian` to activate this Backend Mongodb Guardian persona.
