...
import * as v3 from '@/app/api/v3/plans/child/[childId]/latest/route'

export const runtime = 'nodejs'
export const dynamic = 'force-dynamic'

export async function GET(req: Request, ctx: { params: { childId: string } }) {
  const endpoint = 'plans_latest'
