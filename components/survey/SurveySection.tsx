...
const SECTION_ALL_FIELDS: Record<string, string[]> = {
  ...
  desarrolloSalud: [
    ...
    "alimentacion",
    "alimentacionOtro",
    "alimentacionIntroduccion",
    "comeSolidos",
    "problemasLactancia",
    "asesoriaLactancia",
    "asesoraLactanciaDetalle",
    ...
    "tieneEstudioFerritina",
    "nivelFerritina",
    "fechaEstudioFerritina",
    "consultaOtroDoctor",
    "consultaDoctorDetalle",
    "estudiosMedicos",
    "estudiosMedicosDetalle",
  ],
  actividadFisica: [
    "vePantallas",
    "pantallasDetalle",
...
const FIELD_LABELS: Record<string, Record<string, string>> = {
  informacionFamiliar: {
    ...
    horaRegresoTrabajo: "Hora en que regresa de trabajar",
  ...
  historial: {
    ...
    tallaHijo: "Talla del hijo",
    percentilTalla: "Percentil de talla",
  ...
  desarrolloSalud: {
    ...
    alimentacionIntroduccion: "Cuándo introdujeron la fórmula/leche",
    comeSolidos: "Come solidos",
    problemasLactancia: "Problemas con la lactancia",
    asesoriaLactancia: "Cuenta con asesoria de lactancia",
    asesoraLactanciaDetalle: "Asesora de lactancia",
    edadAlimentacionComplementaria: "Edad inicio alimentacion complementaria (meses)",
    problemasHijo: "Caracteristicas del hijo",
    descripcionInquieto: "Descripcion cuando es muy inquieto para dormir",
    reflujoColicosDetalle: "Detalle de reflujo y/o colicos",
    pesadillasDetalle: "Detalle sobre las pesadillas",
    ...
    tieneEstudioFerritina: "Tiene estudio de ferritina",
    nivelFerritina: "Nivel de ferritina (ng/mL)",
    fechaEstudioFerritina: "Fecha del estudio de ferritina",
    consultaOtroDoctor: "Ha consultado con otro doctor",
    consultaDoctorDetalle: "Detalle consulta con otro doctor",
    estudiosMedicos: "Se le han practicado estudios medicos",
    estudiosMedicosDetalle: "Detalle de estudios medicos",
  },
  actividadFisica: {
  ...
  rutinaHabitos: {
    ...
    temperaturaCuarto: "Temperatura del cuarto (Celsius)",
    unidadTemperatura: "Unidad de temperatura",
    temperaturaOriginal: "Temperatura ingresada (valor original)",
    ...
    horaDespertarDesde: "Hora de despertar (desde)",
    horaDespertarHasta: "Hora de despertar (hasta)",
