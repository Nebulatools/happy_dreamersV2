...
## 1. docs/specs/current/spec.md

The main feature specification - vision, UX, architecture. Created by `/interview` + `/workflows:plan`.

> **IMPORTANT:** Always use `docs/specs/current/` - NOT feature-named folders like `docs/specs/my-feature/`. The script defaults to `current/` and one feature is active at a time.
...
### Related files
```
docs/specs/current/spec.md                 # Full specification (permanent)
docs/specs/current/implementation_plan.md  # Task checklist (temporary)
docs/specs/current/prompt.md               # LLM instructions (temporary)
docs/specs/current/discoveries.md          # Session memory (temporary)
```
...
| Spec | Status | File |
|------|--------|------|
| [Feature Name] | 🟡 In progress | `docs/specs/current/spec.md` |
```

---

## 2. docs/specs/current/prompt.md
...
|------|---------|-----------|
| `docs/specs/current/spec.md` | Feature specification | Start of session |
| `docs/specs/current/implementation_plan.md` | Task checklist | Finding next task |
| `docs/specs/current/discoveries.md` | Memory from past sessions | Start of session |
...
1. Read `docs/specs/current/spec.md`
2. Read `docs/specs/current/discoveries.md`
3. Read `docs/specs/current/implementation_plan.md`
4. Find first `- [ ]` task
5. Execute
```
...
## 3. docs/specs/current/implementation_plan.md
...
## 4. docs/specs/current/discoveries.md
...
```
docs/specs/current/
├── spec.md                    # Feature specification (PERMANENT)
├── prompt.md                  # Instructions per iteration (temporary)
├── implementation_plan.md     # Tasks with [ ] checkboxes (temporary)
└── discoveries.md             # Memory between sessions (temporary)
```
