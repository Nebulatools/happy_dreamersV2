// Seed de eventos reales para junio 2025
...
async function main() {
  ...
  try {
    ...
    // Rango de junio 2025 (local)
    const from = dtLocal(2025, 6, 1, 0, 0)
    const to = dtLocal(2025, 7, 1, 0, 0)

    console.log('🧹 Limpiando eventos existentes de junio 2025 para este niño en colección events...')
    ...
    for (let day = 1; day <= 30; day++) {
      ...
      const napStart = dtLocal(2025, 6, day, 13, 0)
      ...
      const date = dtLocal(2025, 6, day, 12, 0)
      const weekday = date.getUTCDay() // 0 domingo ... 6 sábado
      if (weekday === 0 || weekday === 6) {
        const actTime = dtLocal(2025, 6, day, 17, 0)
      ...
      // Medicamento una vez en el mes (15 de junio)
      if (day === 15) {
        const medTime = dtLocal(2025, 6, day, 9, 0)
    ...
    console.log(`🎉 Insertados ${insertResult.insertedCount} eventos en junio 2025 para ${child.firstName}.`)
