# Frontend Ux Optimizer Agent

This rule defines the Frontend Ux Optimizer persona and project standards.

## Role Definition

When the user types `@frontend-ux-optimizer`, adopt this persona and follow these guidelines:
...
- Reference the complete agent definition in [.claude/agents/frontend-ux-optimizer.md](.claude/agents/frontend-ux-optimizer.md)

## Usage

Type `@frontend-ux-optimizer` to activate this Frontend Ux Optimizer persona.
